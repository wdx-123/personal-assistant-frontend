...
- `<module>` 和 `<task>` 按语义决定中英文：稳定技术名词优先英文，如 `home`、`permission`；更自然的业务表达可保留中文，如 `首页`、`卡片布局调整`。
...
- `plan/首页/pending-卡片布局调整.md`
- `plan/permission/pending-dynamic-route-cleanup.md`
